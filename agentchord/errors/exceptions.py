"""AgentChord exception hierarchy.

All exceptions inherit from AgentChordError for easy catching.
...
class AgentChordError(Exception):
    """Base exception for all AgentChord errors."""
...
class ConfigurationError(AgentChordError):
...
# LLM Errors
class LLMError(AgentChordError):
...
# Agent Errors
class AgentError(AgentChordError):
...
# Cost Errors
class CostLimitExceededError(AgentChordError):
    """Cost limit exceeded."""
...
# Workflow Errors
class WorkflowError(AgentChordError):
