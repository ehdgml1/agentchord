...
Example:
    >>> from agentweave.protocols.a2a import A2AClient, AgentCard
...
def __getattr__(name: str):
    ...
    if name == "A2AClient":
        from agentweave.protocols.a2a.client import A2AClient
        return A2AClient
    elif name == "A2AServer":
        from agentweave.protocols.a2a.server import A2AServer
        return A2AServer
