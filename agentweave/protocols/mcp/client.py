...
from agentweave.protocols.mcp.types import MCPServerConfig, MCPTool, MCPToolResult
...
class MCPClient:
    ...
    Note:
        Requires the `mcp` package: pip install agentweave[mcp]
    """
    ...
    def _require_mcp(self) -> None:
        ...
        if not self._mcp_available:
            raise ImportError(
                ...
                "Install with: pip install agentweave[mcp]"
            )
